            ...
            with st.spinner("大師正在排盤與分析中，請稍候..."):
                ...
                if is_master:
                    if analysis_mode == "【八字精論】":
                        ...
                        └─────────┴─────────┴─────────┴─────────┘
                        - 明確標註【日主】天干屬性：X（五行屬性）
                        - 判定日主旺衰狀態：得令 / 失時 / 不得令（根據月令）
                        
                        ═══════════════════════════════════════════
                        第二大項：【五行能量比例分析】
                        ═══════════════════════════════════════════
                        列出金、木、水、火、土的強弱度（旺、相、休、囚、死）：
                        - 金：X（旺/相/休/囚/死）
                        - 木：X
                        - 水：X
                        - 火：X
                        - 土：X
                        計算比例：同類五行（與日主相同五行）vs 異類五行（剋日主/被日主剋）
                        例如：同類 X 個 vs 異類 X 個（X:X 比例）
                        
                        ═══════════════════════════════════════════
                        第三大項：【格局與五行喜忌】
                        ═══════════════════════════════════════════
                        依據《三命通會》、《滴天髓》、《窮通寶鑑》判定：
                        - 格局名稱：X（例如：普通格局、專旺格、從旺格、從財格等）
                        - 身強/身弱：X（日主旺衰最終判定）
                        - 喜用五行：X（對日主最有利的五行）
                        - 忌諱五行：X（對日主不利的五行）
                        ...
                        第四大項：【十神坐基與特質解析】
                        ═══════════════════════════════════════════
                        針對四柱中各十神所處位置，給予古典命理特質描述：
                        - 年柱十神：X → X（古理解析，例如：偏財在年柱代表祖產或父輩影響）
                        - 月柱十神：X → X（例如：月柱劫財代表手足或同儕關係）
                        - 日主（日元）：X → X（本身的性格與特質）
                        - 時柱十神：X → X（例如：時柱食神代表晚年福澤或子女運）
                        
                        ═══════════════════════════════════════════
                        最後：【大師總結與建議】
                        ═══════════════════════════════════════════
                        依據以上四大項數據，結合客人職業狀態【{occupation}】：
                        - 引用《三命通會》、《滴天髓》、《窮通寶鑑》給予白話註解
                        - 針對職業背景【{occupation}】（自營商、更生人、身障等）給予具同理心的實務建議
                        - 提供趨吉避凶的具體方向
